...
fig, ax = plt.subplots(figsize=(12, 7))  # Larger figure for better legend visibility
...
while True:
    try:
        ...
        # Normalize the bestTree values for each distinct run-structure combination
        ...
        ax.set_title("GP Best Tree Fitness over Multiple Runs", fontsize=14)
        ...
        leg1 = ax.legend(title="Run Information", loc="center left", 
                      bbox_to_anchor=(1.02, 0.5), frameon=True)
        
        # Second legend for action types (bottom)
        ...
        plt.tight_layout(rect=[0, 0.05, 0.85, 0.95])  # leave space for legends
